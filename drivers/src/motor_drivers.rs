...
impl L298n {
    ...
    pub fn set_speed(&mut self, cmd: MotorCommand) -> AeroResult<()> {
        if !self.initialized {
    ...
    fn set_pin_high(&self, pin: u8) -> AeroResult<()> { Ok(()) }
    fn set_pin_low(&self, pin: u8) -> AeroResult<()> { Ok(()) }
    fn set_pwm(&self, pin: u8, duty: u8) -> AeroResult<()> { Ok(()) }
}
...
impl Drv8825 {
    ...
    pub fn step(&mut self, direction: bool, steps: u16) -> AeroResult<()> {
    ...
    fn set_direction(&self, dir: bool) -> AeroResult<()> { Ok(()) }
    fn pulse_step(&self) -> AeroResult<()> { Ok(()) }
}
...
impl Tmc2209 {
    ...
    pub fn move_to(&mut self, target: i32) -> AeroResult<()> {
...
impl Esc {
    ...
    pub fn arm(&mut self) -> AeroResult<()> {
        self.armed = true;
        Ok(())
    }

    pub fn disarm(&mut self) -> AeroResult<()> {
        self.armed = false;
        Ok(())
    }

    pub fn set_throttle(&mut self, throttle: u16) -> AeroResult<()> {
        if !self.armed {
            return Err(aero_types::AeroError::HardwareError);
        }
    ...
    fn set_pwm(&self, pwm: u16) -> AeroResult<()> { Ok(()) }
}
...
impl Servo {
    ...
    pub fn set_angle(&mut self, angle: f32) -> AeroResult<()> {
